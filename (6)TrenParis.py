'''
Descripcio: Modela una simplificacion de la red de trenes de Paris, con un grafo de 2 terminales y caida en aristas (la fuente es "République" y la terminal es "Concorde").
